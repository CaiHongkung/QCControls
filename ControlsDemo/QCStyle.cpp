...
QCStyle::QCStyle(QStyle *style)
    : QProxyStyle(style)
{
    setBaseStyle(QStyleFactory::create("WindowsVista"));
}

QCStyle::~QCStyle()
{
}
void QCStyle::drawControl(ControlElement element, const QStyleOption *option, QPainter *painter, const QWidget *widget) const
{
    switch (element){
...
void QCStyle::polish(QWidget *widget)
{

}
void QCStyle::polish(QPalette &palette)
{

}
void QCStyle::drawPrimitive(PrimitiveElement element, const QStyleOption *option,
...
void QCStyle::drawTab(QStyleOptionTab &myTabOption, QPainter *painter) const
{
    painter->save();
    ...
    {
        backgroundImage = QPixmap(":/ControlsDemo/Resources/pics/tabItem.png");
...
void QCStyle::drawTabText(QStyleOptionTab &myTabOption, QPainter * painter) const
{
    painter->save();
...
QSize QCStyle::sizeFromContents(ContentsType type, const QStyleOption *option, const QSize &contentsSize, const QWidget *widget) const
{
    switch (type)
    {
...
int QCStyle::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    switch (metric)
    {
